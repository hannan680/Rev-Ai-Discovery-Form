    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          <Label
            htmlFor="email"
            className="text-lg font-audiowide text-bright-white"
          >
            Email Address *
          </Label>
          <Input
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            onChange={(e) =>
              updateFormData({ specificBusinessType: e.target.value })
            }
      ...
      <div className="bg-gradient-to-r from-deep-violet to-purple-grape p-4 rounded-lg border border-neon-aqua neon-glow">
        <h4 className="font-audiowide text-cyber-yellow mb-2">
          ℹ️ Why we collect this information
        </h4>
        <p className="text-sm text-soft-lavender font-manrope">
          This basic information helps us understand your business context and
          ensures we can follow up with the right person about your voice AI
          requirements.
        </p>
      </div>
    </div>
